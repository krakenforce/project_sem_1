<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'):
        ...
        $statement = "INSERT INTO product(product_code,name,price,brand,type,image,download)";
        $param = [
            $_POST['product_code'],
            $_POST['name'],
            $_POST['price'],
        ...
        $statement2 = "INSERT INTO product_detail(model,color,ton,cooling_cap,heating_cap,pw_input,eer,fea_01,fea_02,fea_03)";
        $param2 = [
            $_POST['model'],
            $_POST['color'],
            $_POST['ton'],
