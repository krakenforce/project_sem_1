            ...
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <h4 class="text-light text-uppercase mb-0">Update Product</h4>
                        </div>
                        <div class="col-md-5">
                        </div>
                        <div class="col-md-3">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" step="0.01" name="ton" id="" class="form-control"
                                           ...
                                           value="<?php echo $this_product->product_info['ton']; ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" name="cooling_cap" id="" class="form-control"
                                           ...
                                           value="<?php echo $this_product->product_info['cooling_cap']; ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" name="heating_cap" id="" class="form-control"
                                           ...
                                           value="<?php echo $this_product->product_info['heating_cap']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="pw_input" id="" class="form-control"
                                           ...
                                           value="<?php echo $this_product->product_info['pw_input']; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">EER: </label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" name="price" id="" class="form-control"
                                           ...
                                           value="<?php echo $this_product->product_info['price']; ?>">
                                </div>

                                <div class="form-group col-md-9">
                                    <label for="">Type: </label><br>
                                    <input type="radio" name="type" id=""
                                           value="Split AC" <?php echo ($this_product->product_info['type'] == "Split AC") ? "checked" : ""; ?>>
                                    <label for="Split AC">Split AC</label> &nbsp
                                    <input type="radio" name="type" id=""
                                           value="Cabinet AC" <?php echo ($this_product->product_info['type'] == "Cabinet AC") ? "checked" : ""; ?>>
                                    <label for="Cabinet">Cabinet AC </label> &nbsp
                                    <input type="radio" name="type" id=""
                                           value="Cassette AC" <?php echo ($this_product->product_info['type'] == "Cassette AC") ? "checked" : ""; ?>>
                            ...
                            <div class="form-group">
                                <input type="hidden" name="oldPhoto"
                                       value="<?php echo $this_product->product_info['image']; ?>">
                                <img src='<?php echo $this_product->product_info['image']; ?>' id="output"
                                     alt="uploaded-image"
                                     height="100px">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="oldDownload"
                                       value="<?php echo $this_product->product_info['download']; ?>">
