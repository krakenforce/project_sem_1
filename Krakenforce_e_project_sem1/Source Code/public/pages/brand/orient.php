<?php
    ...
    $db = new Database();
    $products = Product::find_product_by_brand_and_type('Orient', 'Split AC');
    $products2 = Product::find_product_by_brand_and_type('Orient', 'Cabinet AC');
    $products3 = Product::find_product_by_brand_and_type('Orient', 'Cassette AC');
?>
<!doctype html>
<html lang="en">
<head>
            ...
            <div class="image_slider">
                <div id="left_image_slider">
                    <div id="wowslider-container1">
                        <div class="ws_images">
                            <ul>
                                <li><img src="../images/slider/orient_slider/012.png" alt="" title="" id="wows1_0">
                                </li>
                                <li><img src="../images/slider/orient_slider/022.png" alt="" title="" id="wows1_2">
                                </li>
                                <li><img src="../images/slider/orient_slider/031.png" alt="" title="" id="wows1_3">
                                </li>
                                <li><img src="../images/slider/orient_slider/041.png" alt="" title="" id="wows1_4">
                                </li>
                                <li><img src="../images/slider/orient_slider/051.png" alt="" title="" id="wows1_5">
                                </li>
                            </ul>
                        </div>
                    </div>
                    <script src="js/orientSlider.js"></script>
                </div>
                <div id="right_image_slider">
                    <img src="../images/slider/orient_slider/orient01.png" alt="" draggable="false">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="display-container_pD1" id="product_Slide-container_pD1">
                        <?php foreach ($products as $product): ?>
                            <div class="product-Box_pD1">
                                ...
                                <a>
                                    <div class="product-Box_hover_pD1" onclick="Orient_Split_01()">
                    ...
                    <div class="display-container_pD2" id="product_Slide-container_pD2">
                        <?php foreach ($products2 as $product2): ?>
                            <div class="product-Box_pD2">
                                ...
                                <a>
                                    <div class="product-Box_hover_pD2" onclick="Orient_Cabinet_01()">
                                        <img src="../images/brands/pbox_search-icon.png" alt="" draggable="false">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="display-container_pD3" id="product_Slide-container_pD3">
                        <?php foreach ($products3 as $product3): ?>
                            <div class="product-Box_pD3">
                                ...
                                <a>
                                    <div class="product-Box_hover_pD3" onclick="Orient_Cassette_01()">
                                        <img src="../images/brands/pbox_search-icon.png" alt="" draggable="false">
                                    </div>
                                </a>
                            </div>
