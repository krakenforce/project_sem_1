...
function product_detail(link,pImage,pPrice,pName,pFeature01,pFeature02,pFeature03,pSpecs01,pSpecs02,pSpecs03) {
    boxEnable();
    link.setAttribute("href", "link");
    pImage.src = "<?php echo $product->product_info['image']; ?>";
    pImage.style.width = "350px";
    pPrice.innerHTML = "81,000/-";
    pName.innerHTML = "<?php $product->product_info['name']; ?>";
    pFeature01.innerHTML = "<?php echo $product->product_info['fea_01']; ?>";
    pFeature02.innerHTML = "<?php echo $product->product_info['fea_02']; ?>";
    pFeature03.innerHTML = "<?php echo $product->product_info['fea_03']; ?>";
    pSpecs01.innerHTML = "Cooling (Btu/h) : <?php echo $product->product_info['cooling_cap']; ?> ";
    pSpecs02.innerHTML = "Power Input (W) : <?php echo $product->product_info['pw_input']; ?>";
    pSpecs03.innerHTML = "EER : <?php echo $product->product_info['eer']; ?>";
    disableScroll()
}
